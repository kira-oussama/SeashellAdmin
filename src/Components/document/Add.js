...
import './../../css/personaldocumentadd.css'
...
class Add extends Component {
    ...
    submitChangeHandler = event=>{
        ...
        Axios.post('http://localhost:8000/api/admin/document/store',postData,headers)
        .then(response=>{
            //document created
            ...
            }else if(response.status===200){//there is an error
        ...
        return (
            <div className='userform'>
                ...
                <div className="alert alert-success image-upload" >
                    ...
                    <button className="btn btn-primary col-2 uploadbtn" onClick={this.defaultHandler}>par default</button>
                    </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <select className="form-control col-6" id='doctype' value={this.state.doctype} onChange={this.doctypeChangeHandler} required=''>
                ...
                <input className="btn btn-primary" type="button" onClick={this.submitChangeHandler} value="Ajouter" />
